...
loginForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (res.ok) {
      // Use the URL injected by the Blade template (window.DASHBOARD_URL)
      // Falls back to '/dashboard' if the template variable is missing.
      window.location.href = window.DASHBOARD_URL || '/dashboard';
    } else {
