...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <a class="nav-item active" id="nav-home" href="<?php echo e(route('dashboard')); ?>">
      ...
      <a class="nav-item" id="nav-timerecord" href="<?php echo e(route('timerecord')); ?>">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
        </svg>
        Time Record
      </a>
      <a class="nav-item" id="nav-settings" href="<?php echo e(route('settings')); ?>">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
...
<?php /**PATH C:\Users\dhary\Documents 3rd\attendance_webbased_system\attendance_laravel\resources\views/dashboard.blade.php ENDPATH**/ ?>