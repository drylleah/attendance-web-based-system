...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/timerecord.css') }}">
  <style>
    @page { margin: 0; }
    @media print {
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item active" href="{{ route('timerecord') }}">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
        </svg>
        Time Record
      </a>
      <a class="nav-item" href="{{ route('settings') }}">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
  ...
  <div class="modal-overlay" id="modalOverlay">
    <div class="modal">
      ...
      <div class="modal-grid">
        ...
        <div class="form-group"><label>Time In</label><input type="time" id="f_timein"></div>
        <div class="form-group"><label>Time Out</label><input type="time" id="f_timeout"></div>
  ...
  <div class="modal-overlay" id="editModalOverlay">
    <div class="modal">
      ...
      <div class="modal-grid">
        ...
        <div class="form-group"><label>Time In</label><input type="time" id="ef_timein"></div>
        <div class="form-group"><label>Time Out</label><input type="time" id="ef_timeout"></div>
  ...
  <script src="{{ asset('js/timerecord.js') }}"></script>
</body>
</html>
